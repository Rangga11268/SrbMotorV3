...
export default function Edit({ promotion }) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        valid_until: promotion.valid_until
            ? promotion.valid_until.split("T")[0]
            : "",
        ...
        <AdminLayout>
            ...
            <CRow>
                ...
                <CCol md={4}>
                    <CAlert
                        color="warning"
                        className="border-0 shadow-sm border-start border-4 border-warning"
                    >
                        <h6 className="font-weight-bold">Perhatian</h6>
                        <p className="small mb-0">
                            Perubahan pada promosi ini akan langsung berdampak
                            pada semua motor yang terhubung dengan promosi ini
                            di halaman publik.
                        </p>
                    </CAlert>
                </CCol>
