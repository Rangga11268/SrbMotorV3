...
export default function CreditStatus({ auth, credit, transaction }) {
    ...
    const statuses = {
        pengajuan_masuk: {
            ...
            description:
                "Pengajuan kredit Anda telah kami terima dan akan segera diproses.",
        },
        menunggu_persetujuan: {
            ...
            description:
                "Tim verifikator kami sedang meninjau kelengkapan dokumen yang Anda unggah.",
        },
        data_tidak_valid: {
            ...
            description:
                "Terdapat dokumen yang kurang jelas atau tidak valid. Silakan periksa catatan perbaikan.",
        },
        dokumen_ditolak: {
            ...
            icon: <AlertCircle className="w-5 h-5" />,
            description:
                "Dokumen yang Anda unggah ditolak. Silakan cek catatan admin dan perbaiki dokumen tersebut.",
        },
        ...
        dikirim_ke_surveyor: {
            ...
            description:
                "Data Anda telah diteruskan ke tim surveyor leasing untuk penjadwalan survey.",
        },
        jadwal_survey: {
            ...
            description:
                "Jadwal survey telah ditentukan. Surveyor akan menghubungi Anda untuk konfirmasi lokasi.",
        },
        disetujui: {
            ...
            description:
                "Selamat! Pengajuan kredit Anda telah disetujui. Silakan selesaikan pembayaran DP.",
        },
        ditolak: {
            ...
            icon: <AlertCircle className="w-5 h-5" />,
            description:
                "Mohon maaf, saat ini pengajuan kredit Anda belum dapat kami setujui.",
        },
    };
    ...
    const steps = [
        ...
        },
        {
            ...
            isActive: ["dikirim_ke_surveyor", "jadwal_survey"].includes(
                credit.status,
            ),
        },
        {
                            ...
                            <div>
                                ...
                                <div className="flex flex-wrap items-center gap-4">
                                    <div className="bg-gray-900 border border-gray-800 px-6 py-3 flex items-center gap-3">
                                        <div
                                            className={`w-3 h-3 rounded-none ${currentStatus.color.replace("bg-", "bg-opacity-80 bg-")}`}
                                        ></div>
                    ...
                    <div className="grid lg:grid-cols-3 gap-12">
                            ...
                            <div className="bg-white border-x border-b border-gray-200 p-8 sm:p-12 shadow-2xl">
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                                    {steps.map((step, i) => (
                                        ...
                                        >
                                            ...
                                            {/* Icon/Number */}
                                            <div
                                                className={`w-[50px] h-[50px] flex items-center justify-center border-2 mb-4 transition-all duration-500 ${
                                                    step.isCompleted
                                            ...
                                            <div className="text-center">
                                                <h4
                                                    className={`text-[11px] font-black uppercase tracking-widest mb-1 ${step.isActive ? "text-[#1c69d4]" : "text-gray-900"}`}
                                                >
                                                    {step.name}
                                                </h4>
                                ...
                                <div className="mt-16 pt-12 border-t border-gray-100">
                                    <div className="flex flex-col md:flex-row gap-8 items-start">
                                        <div
                                            className={`p-5 rounded-none ${currentStatus.color} text-white shrink-0`}
                                        >
                                            <Info size={32} />
                                        </div>
                                        <div>
                                        ...
                                        <div className="flex-1 space-y-8">
                                            <div>
                                                ...
                                                <p className="text-gray-400 text-sm leading-relaxed max-w-md">
                                                    Surveyor kami akan melakukan
                                                    kunjungan ke alamat Anda
                                                    untuk melakukan pengecekan
                                                    data terakhir. Harap
                                                    pastikan Anda berada di
                                                    lokasi pada waktu yang telah
                                                    ditentukan.
                                                </p>
                                            </div>
                                            <div className="grid sm:grid-cols-2 gap-8 pt-4 border-t border-gray-800">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-sm font-bold text-[#1c69d4]">
                        ...
                        <div className="space-y-12">
                            ...
                            <div className="p-10 bg-white border border-gray-200">
                                ...
                                <h3 className="text-2xl font-black text-black uppercase tracking-tighter leading-none mb-1">
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="flex justify-between items-end border-b border-gray-100 pb-4">
                                        <div className="text-left">
                                            <span className="text-[10px] font-black uppercase tracking-widest text-[#1c69d4] block mb-1">
                                                UANG MUKA
                                            </span>
                                    ...
                                    <div className="flex justify-between items-center bg-gray-50 p-5 -mx-5 -mb-5">
                                        <span className="text-[11px] font-black uppercase tracking-[0.2em] text-[#1c69d4]">
                                            CICILAN
                                        </span>
                            ...
                            <div className="bg-[#1c69d4] text-white p-10 relative overflow-hidden group">
                                ...
                                <div className="relative z-10">
                                    <h4 className="text-2xl font-black uppercase tracking-tighter leading-none mb-4">
                                        BUTUH <br />
                                        BANTUAN?
                                    </h4>
                                    <p className="text-xs font-bold text-blue-100 opacity-80 uppercase tracking-widest mb-10 leading-relaxed">
                                        Hubungi tim verifikasi kami melalui
                                        WhatsApp jika ada kendala dalam
                                        pengunggahan atau jadwal survey.
                                    </p>
                                    <button
