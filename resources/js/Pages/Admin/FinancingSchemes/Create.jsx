...
export default function Create({ motors, providers }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route("admin.financing-schemes.store"));
    };

    return (
        <AdminLayout>
            <Head title="Tambah Skema Cicilan" />
            <CRow>
                <CCol md={8}>
                    <CCard className="mb-4 shadow-sm">
                        <CCardHeader className="bg-white py-3">
                            <div className="d-flex justify-content-between align-items-center">
                                <h5 className="mb-0">Tambah Skema Cicilan</h5>
                                <Link
                                    href={route(
