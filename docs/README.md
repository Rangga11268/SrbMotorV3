...
| **[penjelasan_mvc_sistem.html](penjelasan_mvc_sistem.html)** | 🔄 Skenario Presentasi: Penjelasan Alur MVC & Lifecycle Request 15 Menit (Mulai dari .env) | All (Presentasi) |
...
### **Visual UML Diagrams (Premium)**

| File                                                                        | Purpose                                                                       | Format |
| --------------------------------------------------------------------------- | ----------------------------------------------------------------------------- | ------ |
| **[activity_diagram/activityPenjualanKredit.html](activity_diagram/activityPenjualanKredit.html)** | 🔄 Activity Diagram: Visual alur proses penjualan kredit (Swimlanes)          | HTML   |
| **[activity_diagram/activityPenjualanTunai.html](activity_diagram/activityPenjualanTunai.html)**   | 💰 Activity Diagram: Visual alur proses penjualan tunai (2 Aktor)             | HTML   |
| **[activity_diagram/activityBookingService.html](activity_diagram/activityBookingService.html)**   | 🛠️ Activity Diagram: Visual proses booking service & payment (4 Aktor)        | HTML   |
...
| penjelasan_mvc_sistem.html      | 🟢 Active | Jun 14, 2026 | Dev Team     |
