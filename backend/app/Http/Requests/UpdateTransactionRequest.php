...
class UpdateTransactionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        if ($this->transaction_type === 'CREDIT') {
             $rules = array_merge($rules, [
                'credit_detail.dp_amount' => 'required|numeric|min:0|lt:final_price',
                ...
                'credit_detail.approved_amount' => 'nullable|numeric|min:0|lte:final_price',
            ]);
        }
    ...
    public function messages(): array
    {
        return [
            ...
            'credit_detail.dp_amount.lt' => 'Uang muka harus lebih kecil dari total harga motor.',
