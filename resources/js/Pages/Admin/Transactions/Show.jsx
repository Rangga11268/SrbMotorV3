                        ...
                        <div className="p-6">
                            {isEditMode ? (
                                ...
                                <div className="divide-y divide-gray-100">
                                    ...
                                    <InfoRow label="Pekerjaan" value={transaction.customer_occupation} />
                                    <div className="py-3 border-b border-gray-100 flex flex-col sm:flex-row sm:items-start gap-1">
                        ...
                        <div className="p-4 space-y-3">
                            ...
                            <button onClick={() => {
                                Swal.fire({
                                    ...
                                    if (result.isConfirmed) router.post(route("admin.transactions.notifyDocument", transaction.id), { document_type: 'STNK' });
                                });
                            ...
                            <button onClick={() => {
                                Swal.fire({
                                    ...
                                    if (result.isConfirmed) router.post(route("admin.transactions.notifyDocument", transaction.id), { document_type: 'BPKB' });
                                });
