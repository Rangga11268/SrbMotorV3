...
export default function BannersEdit({ banner }) {
    ...
    const [imagePreview, setImagePreview] = useState(banner.image_path || null);
                ...
                <CCol xs={12}>
                    <CCard className="mb-4 shadow-sm">
                        <CCardHeader className="d-flex justify-content-between align-items-center bg-white py-3">
                            <strong className="h5 mb-0">Edit Banner</strong>
                            <Link
